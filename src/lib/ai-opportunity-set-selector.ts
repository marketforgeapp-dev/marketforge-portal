    ...
    const completion = await openai.chat.completions.parse({
      ...
      messages: [
          ...
          content: [
            ...
            "Event-driven work like storm cleanup should not be recommended as hero unless there is explicit current-event support. Seasonal possibility alone is not enough.",
            "Recommendations are revenue plays, not channel tasks. Do not treat GBP posts, Google ads, Meta ads, Yelp ads, email, blog posts, answer snippets, or FAQs as separate opportunities because every approved action already generates those assets.",
            "Same service-family candidates can be valid only when the commercial play is materially different, such as core demand capture versus estimate request, bundle, trust/proof, service-area expansion, or safe schedule-fill.",
            "A bundle can be selected as hero when it is made from real services the business offers, is operationally natural, increases job value, and is stronger than a plain service push. Do not make emergency, event-driven, or speculative bundles hero.",
            "Do not select three visible opportunities from the same service family unless the candidate pool has fewer than four real service families.",
            "Manufacturer offers, rebates, financing, utility incentives, dealer promotions, APR claims, and monthly payment claims are not valid system-recommended variants unless the user explicitly provided them through NLP.",
    ...
    const completion = await openai.chat.completions.parse({
      ...
      messages: [
          ...
          content: [
            ...
            "The visible set should contain revenue plays, not channel tasks. Every approved action already generates GBP, paid ads, email, blog, answer-snippet, and FAQ assets.",
            "If fewer than 6 strong unique service families exist, it is acceptable to include another candidate from the same service family only when the commercial play is clearly different.",
            "Bundle opportunities are allowed to compete for hero placement when they are safe, high-value, operationally natural, and tied to real services the business offers.",
            "Do not select three visible opportunities from the same service family unless the candidate pool has fewer than four real service families.",
            "Do not select two candidates from the same service family when they are just title variations of the same objective.",
            "Do not select manufacturer, rebate, financing, utility incentive, dealer promotion, APR, or monthly-payment actions unless those details came from explicit user-provided NLP context.",
            ...
            "Do not overvalue severe, urgent, or safety-critical services just because they sound important.",
            "Event-driven work like storm cleanup should normally be reserve unless there is explicit current-event support. Do not make it hero from generic urgency alone.",
          ...
          content: JSON.stringify(
            {
              ...
              instructions: [
                ...
                "Choose revenue plays, not channel-specific tasks.",
                "Do not count different asset outputs as different opportunities.",
                "Same-family repeats are only acceptable when the commercial mechanism is materially different.",
                "Do not categorically downrank bundles; a strong bundle can be the top move when it is more commercially useful than a plain service push.",
                "Avoid selecting three opportunities from the same family when other real service families or safe commercial plays are available.",
                "Do not choose externally variable offer variants such as rebates, financing, manufacturer promos, or utility incentives from system recommendations.",
