...
export function buildCampaignImagePrompt(params: {
  ...
  return [
    ...
    `Internal campaign context, not image text: ${params.actionTitle}.`,
    `Visual service context: ${params.actionSummary}.`,
    ...
    "- The only text allowed in the image is the business name, and only if it appears naturally on a service truck, shirt, storefront sign, yard sign, or equipment.",
    "- Do not place the action title, campaign headline, offer, CTA, slogan, or promotional message anywhere in the image.",
