  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <p className="mt-2 text-sm leading-6 text-gray-600">
        MarketForge estimates how prepared your business is to appear in answer-engine
        and AI-assisted local search results based on FAQ coverage, service-page depth,
        and answer-ready content signals.
      </p>
    </div>
  );
}